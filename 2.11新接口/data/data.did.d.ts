...
export interface UploadSumArgs {
  'id' : bigint,
  'year_end' : bigint,
  'upload_count' : bigint,
  'name' : string,
...
export interface data {
  ...
  'getCertainFieldData' : ActorMethod<
    ...
    [] | [FieldReserve__1],
  >,
  'getCertainRegionLevelSumSoc' : ActorMethod<
    [RegionLevel__1],
    Array<SumRESERVES>,
  >,
  ...
  'getCertain_RegionLevel_sumFiledData' : ActorMethod<
    ...
    Array<SumRESERVESContainField>,
  >,
  'getCertanin_RegionLevel_AllData' : ActorMethod<
    [DataSource__1, RegionLevel__1],
    Array<RESERVES>,
  >,
  ...
  'uploadSumData' : ActorMethod<[UploadSumArgs], Result>,
